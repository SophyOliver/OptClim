function plotParamPairMisfitsCmaes(optDir, outDir, scale)
...
%
% Examples: 
% plotParamPairMisfits('/Users/orie3677/Documents/Uni/Project/Optimization/OptClim/OxfordMOPS/test_MOPS_cmaes')
% plotParamPairMisfits('/Users/orie3677/Documents/Uni/Project/Optimization/OptClim/OxfordMOPS/test_MOPS_cmaes', '/Users/outFigures')
%
...
[misfits, paramVals, bestPop, bestGen] = i_getCmaesResults(optDir, genFields(iOrder), parNames);
...
for pp = 1:numPlots
    ...
    for g = 1:maxGen
        ...
        yval = paramVals.(ypar)(bestPop(g), g);
        xval = paramVals.(xpar)(bestPop(g), g);
        cval = misfits(bestPop(g), g);
