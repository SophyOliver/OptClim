...
class ModelSimulation(object):
    ...
    def __init__(self, dirPath, obsNames=None,
                 ...
                 verbose=False, runscriptName=None):
        """
        ...
        if create:
            self.createModelSimulation(parameters=parameters, ppExePath=ppExePath, obsNames=obsNames, name=name,
                                       ppOutputFile=ppOutputFile, refDirPath=refDirPath, verbose=verbose, runscriptName=runscriptName)
        else:
    ...
    def createModelSimulation(self, parameters, ppExePath=None, obsNames=None, name=None,
                              ppOutputFile='observations.nc', refDirPath=None, verbose=False, runscriptName=None):
        ...
        config['runscriptName'] = runscriptName
